...
module.exports = function (eleventyConfig) {
  ...
  // Call the inject function to enable Vercel Web Analytics
  inject();
  ...
  eleventyConfig.addFilter("slugify", function (str) {
    return slugify(str, {
      ...
      .split("-")
      .slice(0, 5)
      .join("-"); // only include first 5 words
  });
  ...
  eleventyConfig.addFilter("noQBFooterTags", (post) => {
    ...
    return post.replace(footerTags, "");
  });
  ...
  eleventyConfig.addShortcode(
    "asset_img",
    (filename, alt, path = "/assets/img/posts/") =>
